                ...
                html += `
                        <div class="song ${data_index == indexSong ? "active" : ""
                            ...
                            <div class="body" id=" ` + data_index + `"onclick='select_song(this)' >
                             ...
                             <div class="option">
                                <i class="fa-sharp fa-solid fa-trash" style="cursor:pointer;" onclick="Delele(` + item.id + `)" ></i>
                            </div>
                    </div>
                    `;
